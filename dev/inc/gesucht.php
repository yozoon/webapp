		...
		<div class="gesucht">
			<div class="d-flex flex-row">
				...
				<?php if ($USER["gleich"]) { ?>
					...
					<button class="btn btn-success eingabe mr-2" id="zielpersonsubmit" tabindex="15" type="button">speichern</button>
					<button class="btn btn-danger abbrechen mr-2" tabindex="16" type="button">abbrechen</button>
				<?php } ?>
					<button type="button" class="btn btn-secondary schliessen" data-dismiss="modal" type="button">Schliessen</button>
				</div>
			</div>
			<form id="personenbild" class="eingabe" action="<?php echo $mapbaseURL; ?>inc/upload_image.php" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="file" id="upload_image" name="upload_image" class="form-control" accept="image/*;capture=camera">
				</div>
				<div class="form-group">
