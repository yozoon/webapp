<nav class="editmenu d-flex bg-white">
	...
	<div class="btn-group">
		...
		<div class="dropdown-menu">
			...
			?>
				<button class="btn border-0 btn-outline-danger showuserdetails" data-usersync="<?php echo($usersync);?>" data-oid="<?php echo $_SESSION["etrax"]["OID"];?>" data-uid="<?php echo $_SESSION["etrax"]["UID"];?>" data-name="<?php echo $_SESSION["etrax"]["name"];?>" data-dienstnummer="<?php echo $_SESSION["etrax"]["dienstnummer"];?>" data-typ="<?php echo $_SESSION["etrax"]["typ"];?>" data-username="<?php echo $_SESSION["etrax"]["name"];?>" data-email="<?php echo $_SESSION["etrax"]["email"];?>" data-bos="<?php echo $_SESSION["etrax"]["bos"];?>" data-telefon="<?php echo $_SESSION["etrax"]["telefon"];?>" data-einsatzfaehig="<?php echo $_SESSION["etrax"]["einsatzfaehig"];?>" data-notfallkontakt="<?php echo $_SESSION["etrax"]["notfallkontakt"];?>" data-notfallinfo="<?php echo $_SESSION["etrax"]["notfallinfo"];?>" data-kommentar="<?php echo $_SESSION["etrax"]["kommentar"];?>" title="Nutzerdaten anzeigen und bearbeiten"><i class="material-icons gray-dark pr-2">edit</i> Userdaten bearbeiten</button>
			<?php } ?>
