...
while ($result = $db_organisation->fetch(PDO::FETCH_ASSOC)){
	...
	//Arten von Ressourcen werden über inc/include.php geholt $ressource[""]
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="settingsmodalheader" style="font-weight:bold;">Ressourcen Details: </h5>
			</div>
			<div class="modal-body">
				<div class="form-group row">
					...
					<div class="col-sm-9">	
						<input disabled type="text" name="name" class="mb-2 form-control-plaintext z_res_edit z_name checkJSON" id="name" placeholder="Bezeichnung der Ressource" value=""></input>
					</div>
				</div>
				<div class="form-group row">
					<label for="kennung" class="col-sm-3 col-form-label">Kennung</label>
					<div class="col-sm-9">	
						<input disabled type="text" name="kennung" class="mb-2 form-control-plaintext z_res_edit z_kennung checkJSON" id="kennung" placeholder="Kennung der Ressource (z.B. Kennzeichen)" value=""></input>
					</div>
				</div>
				<div class="form-group row">
					<label  class="col-sm-3 col-form-label" for="res_typ">Typ</label>
					<div class="col-sm-9">
						<select disabled name="res_typ" id="res_typ" size="1" class="mb-2 form-control-plaintext z_res_edit form-control z_typ">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input disabled type="textbox" name="beschreibung" class="mb-2 form-control-plaintext z_res_edit z_beschreibung checkJSON" id="beschreibung" placeholder="Beschreibungstext" value=""></input>
					</div>
				</div>
				<div class="mx-auto order-md-1 text-center mt-4">	
					<button type="button" class="btn btn-primary res_modify">Daten bearbeiten</button>
					<button type="button" class="btn btn-success abschliessen res_modify_save" title="Änderungen speichern" data-toggle="tooltip" data-placement="bottom" data-rid="" style="display:none;" data-uid="">Änderungen speichern</button>
					<?php if($userlevel <= 3 && is_numeric($userlevel)){ ?>
					<button type="button" class="btn btn-danger res_modify_delete" title="Ressource löschen" data-toggle="tooltip" data-placement="bottom" data-rid=""><i class='material-icons text-white'>delete_forever</i></button>
					<?php } ?>
				</div>
