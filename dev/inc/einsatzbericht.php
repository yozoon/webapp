...
<?php 
require $baseURL."sessionhandler.php"; //Der Sessionhandler schreibt die Sessionwerte neu
...
if($USER["lesen"]){ //Mindestens Leserechte werden benötigt um etwas angezeigt zu bekommen.
	...
	?>
				<form id="einsatzbericht" action="#" method="post">
					<h3>Einsatzbericht Primärorganisation:</h3>
					<div class="col-sm-12">
					...
					<h3 style="padding-top:35px;">Einsatzbericht <?php echo $org_arr[$_SESSION["etrax"]["adminOID"]]["kurzname"];?>:</h3>
					<div class="col-sm-12">
				...
				<div class="pt-4">
				<?php if($USER["zuweisen"]){ ?>
					<button  class="btn btn-primary berichtbearbeiten" type="button">Bearbeiten</button>
					<button class="btn btn-success eingabe" id="einsatzberichtsubmit" type="button" data-ebid="eb_<?php echo $_SESSION["etrax"]["adminOID"];?>" tabindex="15">Speichern</button>
					<button class="btn btn-danger eingabe abbrechen" type="button" tabindex="16">Abbrechen</button>
				<?php } ?>
					<button type="button" class="btn btn-secondary schliessen" type="button" data-dismiss="modal">Schliessen</button>
				</div>
			</form>
			<script>
				...
				/*if(is_file($baseURL."inc/read_write_db.php")){
					echo 'var rwdb = "inc/read_write_db.php";';
				} elseif(is_file($baseURL."v5/inc/read_write_db.php")) {
					echo 'var rwdb = "v5/inc/read_write_db.php";';
				} else {*/
					echo 'var rwdb = "inc/read_write_db.php";';
				//}
				?>
