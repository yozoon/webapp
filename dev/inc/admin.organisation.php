			...
			<section class="col-12">	
				<div id="<?php echo($oidtemp);?>_org_details" class="row card" id="infos">
					...
					<div id="infocollapse" class="collapse w-100" aria-labelledby="infoheading" data-parent="#<?php echo($oidtemp);?>_org_details">
						<div class="form-group d-flex pl-3">
							...
							<input disabled type="text" name="Bezeichnung_<?php echo($oidtemp);?>" class="form-control checkJSON <?php if($userlevel == 3 && is_numeric($userlevel)){ echo "input_oid_".$oidtemp;}?>" id="Bezeichnung_<?php echo($oidtemp);?>" placeholder="Vollständiger Name der Organisation" value="<?php echo isset($data_org_json->bezeichnung) ? $data_org_json->bezeichnung : "";?>">
						</div>
						<div class="form-group d-flex pl-3">
							<label for="Kürzel_<?php echo($oidtemp);?>">Kürzel</label>
							<input disabled type="text" name="Kürzel_<?php echo($oidtemp);?>" class="form-control checkJSON <?php if($userlevel == 3 && is_numeric($userlevel)){ echo "input_oid_".$oidtemp;}?>" id="Kürzel_<?php echo($oidtemp);?>" placeholder="Kurznamen der Organisation" value="<?php echo isset($data_org_json->kurzname) ? $data_org_json->kurzname : "";?>">
						</div>
						<div class="form-group d-flex pl-3">
							<label for="Anschrift_<?php echo($oidtemp);?>">Anschrift</label>
							<input disabled type="text" name="Anschrift_<?php echo($oidtemp);?>" class="form-control checkJSON <?php if($userlevel == 3 && is_numeric($userlevel)){ echo "input_oid_".$oidtemp;}?>" id="Anschrift_<?php echo($oidtemp);?>" placeholder="Anschrift der Organisation" value="<?php echo isset($data_org_json->adresse) ? $data_org_json->adresse : "";?>">
						</div>
						<div class="form-group d-flex pl-3">
						...
						<div class="form-group d-flex pl-3">
							...
							<select disabled name="Land" id="Land" size="1" class="form-control laenderwahl <?php if($userlevel == 3 && is_numeric($userlevel)){ echo "input_oid_".$oidtemp;}?>">
				...
				<div id="<?php echo($oidtemp);?>_logo" class="row card" id="infos">
					...
					<div id="logocollapse" class="collapse w-100" aria-labelledby="logoheading" data-parent="#<?php echo($oidtemp);?>_logo">
						<div class="form-group pl-3">
						<button class="<?php if($userlevel == 3 && is_numeric($userlevel)){ echo "btn-logoupload";}?>" data-oid="<?php echo($oidtemp);?>">
