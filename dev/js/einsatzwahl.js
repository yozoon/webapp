	...
	let start_scripts = function(){
		...
		let Einsatz_anlegen = function(that){
			...
			if($("#einsatzname").val() != ""){
				...
				database_call('settings','insert','','','',{EID : neueEID, typ : e_typ, data : [einsatz_vars], protokoll : [einsatz_data] ,pois : poi_vars, suchgebiete : search_vars, checkliste:[checkliste_eintrag], gesucht:[{gesuchtbild: "img/no-pic.jpg"}]},Einsatz_angelegt,false);
			}else{
