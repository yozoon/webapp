...
jQuery(function() {
	...
	jQuery('body').on('click','.settings a',function() {
		jQuery(".settingsmodal .modal-body").load( "inc/einstellungen.php?t="+timestamp(), function() {
	...
	jQuery('body').on('click','.open-gesucht a',function() {
		$(".gesuchtePerson .modal-body").load("inc/gesucht.php?t="+timestamp(), function(responseTxt, statusTxt, xhr){
	...
	jQuery('body').on('click','.checkliste a',function() {
		...
		jQuery(".checklisteEinsatz .modal-body").load( "inc/checkliste.php?t="+timestamp(), function() {
			jQuery(".checklisteEinsatz").modal("show");
		});
	});
	jQuery('body').on('click','.showbericht a',function() {
		jQuery(".berichtEinsatz .modal-body").load( "inc/einsatzbericht.php?t="+timestamp(), function() {
	...
	timeval();
	jQuery("#changetime").click(function() {
		clearTimeout(timer);
	});
