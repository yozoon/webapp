$(function () {	
	...
	$(".showuser button").click(function() {
		...
		var dienstnummer = $(this).data("dienstnummer");
		var typ = $(this).data("typ");
		var fid = $(this).data("fid");
		var username = $(this).data("username");
		var pause = $(this).data("pause");
		var ausbildungen = $(this).data("ausbildungen");
		var email = $(this).data("email");
		var einsatzfaehig = $(this).data("einsatzfaehig");
		$('#einsatzfaehig option[value=' + einsatzfaehig + ']').attr('selected', 'selected');
		var bos = $(this).data("bos");
		var telefon = $(this).data("telefon");
		var notfallkontakt = $(this).data("notfallkontakt");
		var notfallinfo = $(this).data("notfallinfo");
		var kommentar = $(this).data("kommentar");
		var uid = $(this).data("uid");
		var oid = $(this).data("oid");
		var usersync = $(this).data("usersync");
		var funktionen_k = $(".alle_funktionen_kurz_" + oid + "").val(); //Alle Funktionen der Organisation Lange Bezeichnung
		if (funktionen_k.includes(";")) {
			funktionen_k = funktionen_k.split(";");
		} else {
		...
		var funktionen_l = $(".alle_funktionen_lang_" + oid + "").val(); //Alle Funktionen der Organisation Lange Bezeichnung
