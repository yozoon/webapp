...
require "inc/include.php"; //Definition des Kartenmaterials
...
/*$USER["dev"] = $_SESSION["etrax"]["USER"]["dev"];
$USER["einsatzleitung"] = $_SESSION["etrax"]["USER"]["einsatzleitung"];
$USER["gleich"] = $_SESSION["etrax"]["USER"]["gleich"];
$USER["zeichnen"] = $_SESSION["etrax"]["USER"]["zeichnen"];
$USER["zuweisen"] = $_SESSION["etrax"]["USER"]["zuweisen"];
$USER["lesen"]= $_SESSION["etrax"]["USER"]["lesen"];*/

$einsatz_query = $db->prepare("SELECT EID,data,lastupdate,typ FROM settings WHERE EID = " . $EID . "");
	...
	<body class="background einsatz-start">
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="settingsmodalheader"><?php echo $einsatztyp; ?> Einstellungen:</h4>
					</div>
				...
				<div class="modal-content">
					<div class="modal-header">
						<div class="row col-12">
							...
							<div class="col-1">
								<a href="pdf/einsatzberichtpdf.php?eb_funk=1" target="_blank" class="d-flex align-items-center" data-toggle="tooltip" data-placement="center" title="Funkprotokoll drucken"><i class="material-icons">print</i></a>
							</div>
						</div>
					</div>
					<div class="modal-body">
								...
								<form id="funkprotokoll" class="text-left">
									<div class="form-group row">
										...
										<div class="col-sm-10 d-flex">
											<input type="text" class="form-control col-7" name="time" id="ftime" value="<?php echo date('Y-m-d H:i:s'); ?>" tabindex="1">
											<input type="button" class="btn btn-primary col-4 ml-2" id="changetime" value="manuelle Zeit">
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10 text-left">
											<?php if($_SESSION["etrax"]["USER"]["zuweisen"]){ //User muss mehr als Leserechte haben um protokollieren zu können?>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						...
						<a href="pdf/einsatzberichtpdf.php?eb_vermisst=1" target="_blank" class="mr-2" data-toggle="tooltip" data-placement="center" title="Datenblatt vermisste Person drucken"><i class="material-icons">print</i></a>
						<a href="pdf/handzettel.php" target="_blank" data-toggle="tooltip" data-placement="center" title="Handzettel zur vermissten Person drucken"><i class="material-icons">description</i></a>
					</div>
					<div class="modal-body">
					</div>
				</div>
		...
		<div class="modal fade checklisteEinsatz" tabindex="-1" role="dialog" aria-labelledby="checklisteEinsatz" aria-hidden="true" data-keyboard="<?php if ($USER["gleich"]) {echo "false";} ?>" data-backdrop="<?php if ($USER["gleich"]) {echo "static";} ?>">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="checklisteEinsatz">Einsatzcheckliste:</h5>
						<a href="pdf/einsatzberichtpdf.php?eb_checkliste=1" target="_blank" class="d-flex align-items-center ml-auto" data-toggle="tooltip" data-placement="center" title="Datenblatt vermisste Person drucken"><i class="material-icons">print</i></a>
					</div>
					<div class="modal-body">
					</div>
				</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<div class="row col-12">
							<div class="col-11">
								<h5 class="modal-title" id="einsatzberichte">Einsatzbericht:</h5>
							</div>
							<div class="col-1">
								<a href="pdf/einsatzberichtpdf.php?eb_einsatzbericht=1" target="_blank" class="d-flex align-items-center" data-toggle="tooltip" data-placement="center" title="Datenblatt vermisste Person drucken"><i class="material-icons">print</i></a>
							</div>
						</div>
					</div>
					<div class="modal-body">
		...
		<div class="modal fade protokolle" tabindex="-1" role="dialog" id="protokolle" aria-labelledby="protokolleheader" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="protokolleheader">Elemente Auswählen:</h5>
					</div>
					<div class="modal-body">
						<div class="col-12">
							...
							<form action="pdf/einsatzberichtpdf.php" target="_blank" method="post">
								...
								<select id="kartenmaterial" name="kartenmaterial" class="setRight custom-select custom-select-lg mb-3">
									...
									$db_org = $db->prepare("SELECT maps FROM organisation WHERE OID = '" . $OID_admin . "'");
								...
								<input class="btn btn-success" type="submit" value="Protokoll erstellen" tabindex="4">
							</form>
						...
						<div class="modal-body">
							<div class="col-12 text-center">
								...
								<ul id="mitgliederliste" class="text-left">
									...
									$db_mitglieder = $db->prepare("SELECT OID,UID,data,EID FROM user WHERE " . $OID_q . " AND EID NOT LIKE '" . $EID . "' AND EID NOT LIKE '0' ORDER BY OID ASC");
		...
		<div id="mama">
			<div class="servicediv">
				...
				<div id="login" class="text-center <?php echo $einsatztyp == "Übung" ? "bg-warning" : ""; ?>">
							...
							if (!$ende) {
								...
								if ($_SESSION["etrax"]["etraxadmin"] === true) { ?>
									...
									<div class="starticons anreise screen">
										<a href="mapview.php#anreise" target="_blank" data-toggle="tooltip" data-placement="left" title="Mitglieder in Anreise"><i class="material-icons">directions_car</i>Anreisekarte</a>
									</div>
									<?php
									//if($_SESSION["etrax"]["userrechte"] <= 2){
									if ($USER["gleich"]) {
					...
					<div class="clearfix"></div>
					<a class="btn btn-primary mt-4" href="einsatzwahl.php"><i class="material-icons text-white">arrow_back</i>Zurück zur Einsatzauswahl</a>
